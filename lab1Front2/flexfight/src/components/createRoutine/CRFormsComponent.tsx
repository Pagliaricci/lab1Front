...
const CRFormsComponent: React.FC = () => {
    ...
    const handleCreateRoutine = async (event: React.FormEvent) => {
        ...
        const exercisesPayload = exercises.map((exercise, index) => ({
            ...
            day: index + 1,  // Assuming day starts from 1 for each exercise
        }));
        ...
        const payload = {
            ...
            creator: "5dc4a7b9-0dbf-4152-ba14-c73e29ab844f",  // Example creator ID
    ...
    return (
        <div className="w-full h-full">
            <div className="flex justify-center items-center min-h-screen bg-gray-100">
                <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-lg" onSubmit={handleCreateRoutine}>
                    ...
                    <div className="overflow-y-auto transition-all duration-300" style={{ maxHeight: `${weekContainerHeight}px` }}>
